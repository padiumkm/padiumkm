            ...
            <div className="max-w-screen-lg w-full bg-white rounded-lg lg:flex h-fit overflow-hidden">
                <div className="flex flex-col justify-center items-center w-full h-screen lg:h-full p-10">
                    ...
                    <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                        <div className="w-full space-y-2 mb-4">
                            <label className="block text-paletteText-primary text-sm font-semibold">Nama</label>
                            <input  {...register("name", {
                                    required: true,
                                    pattern: /^[a-zA-Z\s]$/,
                                    validate: (value) => value.toString().length >= 2,
                                    })}
                                    className={`${errors.name && "border-red-500"} appearance-none border rounded w-full py-2 px-3 text-grey-darker focus:outline-none false`}
                                    id="name"
                                    type="text"
                                    placeholder="John"
                                    />
                        ...
                        <div className="w-full space-y-2 mb-4">
                            ...
                            <input {...register("email", {
                                    ...
                                    className={`${errors.email && "border-red-500"} appearance-none border rounded w-full py-2 px-3 focus:outline-none`}
                                    />
                            <span className="text-red-500 text-xs">
                        ...
                        <div className="w-full space-y-2 mb-6">
                            ...
                            <div className="relative items-center w-full border border-borderCard-divider text-paletteText-primary rounded-[8px] px-2 leading-tight sm:flex false">
                                <div className="flex items-center relative w-full ">
                                    <div className="flex justify-center pr-2 mr-2 border-r border-borderCard-divider text-paletteText-primary text-sm h-1/2">+62</div>
                                        <div className="w-full h-full">
                                            <input {...register("phone", {
                                                    ...
                                                    autoComplete="none"
                                                    className={`${ errors.phone && "border-red-500"} py-2 text-primaryText text-sm w-full focus:outline-none`}
                                                    name="phone"
                                                    type="number"
                            ...
                            <span className="text-red-500 text-xs">
                                {errors.phone?.type === "required" && "Nomor Telepon wajib diisi"}
                                {errors.phone?.type === "pattern" && "Format Nomor Telepon salah"}
                                {errors.phone?.type === "validate" && "Nomor Telepon minimal 8 karakter"}
                            </span>
                        </div>
                        ...
                        <div className="w-full mb-2">
                            <p className="text-center text-sm text-primaryText">Dengan mendaftar, saya menyetujui{" "}
                            ...
                            <p className="text-center text-sm text-primaryText">serta{" "}
                                <span className="text-primary text-sm cursor-pointer hover:text-opacity-70">
                        ...
                        <div className="w-full">
                            <p className="text-center text-sm text-primaryText">Sudah punya akun PaDi UMKM?{" "}
                                <span className="text-primary text-sm cursor-pointer hover:text-opacity-70">
                ...
                <div className="relative bg-gradient-to-r from-[#0193AC] to-[#3EC4DB] lg:max-w-screen-sm w-full hidden lg:flex flex-col justify-center items-center p-10">
                    <div className="space-y-4">
                        <div className="text-2xl text-white font-bold text-left">Belanja Efisien Kemana Saja</div>
                        <div className="text-white text-left">Dengan berbagai kemudahan berbelanja di PaDi UMKM, proses transaksi pembelanjaan menjadi cepat dan efisien tanpa harus melewati proses yang merepotkan. Barang akan sampai kemana pun yang Anda inginkan dengan aman.</div>
                    </div>
