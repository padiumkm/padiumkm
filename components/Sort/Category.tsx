  ...
  return (
    <div className="flex flex-row justify-between">
      ...
      <details className="group relative" open={show}>
        ...
        <div className=" flex flex-row h-full mx-2 border rounded p-2 justify-between ">
          <input
            className="focus:outline-none bg-transparent placeholder:text-[#8F95B2] w-80 text-sm"
